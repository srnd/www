...
return array(
    ...
    "404-text"              => "You should check the URL bar for misspellings. If you don't find one, it's likely one of my pages changed recently. You can email contact@srnd.org for help.",
    "404-img-alt"           => "An empty room.",
    "404-img-title"         => "404 CodeDay Not Found",

    "500-title"             => "Error",
    "500-tag"               => "Something is wrong.",
    "500-text"              => "Sorry, I encountered an error handling your request. I automatically notified the srnd.org technical team to look into this. If you'd like a personal follow-up to this error, please send an email to contact@srnd.org.",
